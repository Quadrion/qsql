...
namespace qtl
{
	...
	/// <summary>
	/// Represents two directional comparisons
	/// </summary>
	...
	/// <summary>
	/// Represents a tree storing values on a two dimensional
	/// comparator
	/// </summary>
	/// <typeparam name="T">
	/// Type stored in quadtree
	/// </typeparam>
	/// <typeparam name="Comparator">
	/// Class implementing the comparator interface, which is
	/// Direction Comparator<T>::direction(T, T);
	/// </typeparam>
	/// <typeparam name="BucketSize">
	/// Default bucket size
	/// </typeparam>
	...
	public:
		/// <summary>
		/// Constructs a new quadtree with opposing corners at (x - halfWidth, y - halfHeight), (x + halfWidth, y + halfHeight)
		/// </summary>
		/// <param name="x">
		...
		/// <summary>
		/// Deletes contents of quad tree
		/// </summary>
		~pr_quadtree();

		/// <summary>
		/// Checks if quadtree contains the given value
		/// </summary>
		/// <param name="value">
		/// Value to insert
		/// </param>
